...
class _FeedCardProfileState extends State<FeedCardProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (context) {
      return store.mapDeletedPost[widget.postId] == false ||
              store.mapDeletedPost[widget.postId] == null
          ? StatefulBuilder(
                                      ...
                                      children: [
                                        StreamBuilder(
                                            stream: FirebaseFirestore.instance
                                                ...
                                                .snapshots(),
                                            builder: (context,
                                                snapshotDoctorConnected) {
                                              if (snapshotDoctorConnected
                                                  .hasData) {
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                store.postEditing(widget.postId);
